    ...
    return (
        <article className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <header className="mb-12">
                ...
                <div className="flex items-center text-neutral-600 dark:text-neutral-400 mb-8 space-x-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {postData.tags?.map((tag: string) => (
                            <span
                                key={tag}
                                className="px-2.5 py-1 text-xs font-medium text-indigo-700 dark:text-indigo-300 bg-indigo-500/10 rounded-full border border-indigo-500/20"
                            >
                                {tag}
                            </span>
                        ))}
                ...
                {postData.desc && (
                    <p className="text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed border-l-2 border-indigo-500/50 pl-4 py-1 italic">
                        "{postData.desc}"
                    </p>
                )}
            </header>
            ...
            <div
                className="prose dark:prose-invert prose-indigo max-w-none prose-p:leading-relaxed prose-pre:bg-black/5 dark:prose-pre:bg-white/5 prose-pre:border prose-pre:border-black/10 dark:prose-pre:border-white/10 prose-headings:text-neutral-900 dark:prose-headings:text-neutral-100 prose-a:text-indigo-600 dark:prose-a:text-indigo-400 prose-a:no-underline hover:prose-a:underline"
