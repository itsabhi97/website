    ...
    <div className="flex flex-col items-start justify-center min-h-[80vh] w-full animate-in fade-in zoom-in duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full pt-8 border-t border-white/5">
        ...
        <div className="flex flex-col space-y-3 group">
          ...
          <p className="text-neutral-500 text-sm leading-relaxed">Full-stack web applications and robust backend APIs built for modern scale.</p>
        </div>
        <div className="flex flex-col space-y-3 group">
          ...
          <p className="text-neutral-500 text-sm leading-relaxed">Deploying highly-available cloud-native systems with modern DevOps practices.</p>
        </div>
      </div>
