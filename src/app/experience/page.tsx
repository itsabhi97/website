...
export default async function ExperiencePage() {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-700">
            <div className="mb-16">
                <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-neutral-900 dark:text-white mb-6">Experience & Certifications</h1>
            ...
            <div className="space-y-24">
                <section>
                    <div className="flex items-center space-x-4 mb-10">
                        <h2 className="text-3xl font-bold text-neutral-900 dark:text-white tracking-tight">Work Experience</h2>
                        <div className="flex-1 h-px bg-black/10 dark:bg-white/10" />
                    </div>

                    <div className="relative space-y-12">
                        {/* Vertical Timeline Line */}
                        <div className="hidden md:block absolute left-4 top-2 bottom-2 w-px bg-black/10 dark:bg-white/10" />

                        {processedExperience.map((job) => (
                            <div key={job.slug} className="relative">
                                {/* Timeline Dot */}
                                <div className="hidden md:flex absolute -left-[1.35rem] top-6 w-5 h-5 rounded-full bg-blue-500/10 dark:bg-blue-500/20 border-4 border-[#F9FAFB] dark:border-[#050505] items-center justify-center z-10">
                ...
                <section>
                    <div className="flex items-center space-x-4 mb-10">
                        <h2 className="text-3xl font-bold text-neutral-900 dark:text-white tracking-tight">Certifications</h2>
                        <div className="flex-1 h-px bg-black/10 dark:bg-white/10" />
                    </div>
