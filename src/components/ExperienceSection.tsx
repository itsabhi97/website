...
export default async function ExperienceSection() {
    ...
    return (
        <div id="experience" className="w-full mt-24 mb-16 border-t border-black/5 dark:border-white/5 pt-16 scroll-mt-24">
                        ...
                        <div className="relative space-y-12">
                            ...
                            {processedExperience.map((job) => (
                                <div key={job.slug} className="relative">
                                    {/* Timeline Dot */}
                                    <div className="hidden md:flex absolute -left-[1.35rem] top-6 w-5 h-5 rounded-full bg-blue-500/20 border-4 border-[#F9FAFB] dark:border-[#0a0a0a] items-center justify-center z-10">
