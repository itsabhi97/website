            ...
            <GlowCard className="group relative rounded-2xl border border-white/5 bg-white/5 p-6 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm">
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between mb-4">
                    <div>
                        ...
                        <p className="text-lg font-medium text-neutral-300">{company}</p>
                    </div>
                    <div className="mt-2 md:mt-0 flex items-center text-sm font-semibold text-neutral-400 bg-white/5 px-3 py-1 rounded-full border border-white/10">
                        <Briefcase className="w-3.5 h-3.5 mr-2 text-blue-400" />
                        {date}
                    </div>
                </div>
